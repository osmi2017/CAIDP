                            ...
                            <div class="row clearfix">
                                ...
                                <div id="file-container">
	                                <div class="form-group">
                                        ...
                                        <a href="{{ asset('admincaidp/demandes/' . $subFile) }}" target="_blank">{{$subFile}}</a>
                                        @endforeach
                                        @else
                                        <a href="{{ asset('admincaidp/demandes/' . $subFile) }}" target="_blank">{{$file}}</a>
                                        @endif
                                        <input type="text" class="file-name" placeholder="Nom du document" name="document_names[]" value=>
