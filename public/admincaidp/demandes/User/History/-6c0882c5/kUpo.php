...
Route::get('resulat-recherche/', 'AccueilController@resulatRecherche')->name('resulatRecherche');
...
Route::delete('/documents/{file}',  'DemandeController@destroy1')->name('documents.destroy');
...
Route::group(['prefix'=>'requerant'], function(){
	...
	route::get('/formulaire-saisine/', 'UsagerController@formSaisine')->name('requerant.formSaisine');
