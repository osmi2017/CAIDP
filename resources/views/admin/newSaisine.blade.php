                       ...
                       <!-- <li  class="disabled {{ $CheckSaisineEdit->addDone($Saisine) }} " >
                        ...
                        <li  class="disabled {{ $Saisine && count($Saisine->contentieu)!=0 ? "done" : "" }}" >
                        	<a id="wizard_horizontal-t-5" href="#" data-content="wizard_horizontal-p-5">
                        		<span class="number">5</span> <br>Instruction du dossier
                        	</a>
                        </li>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="">
                                           	...
                                           	<input type="radio" name="typeDecision" class="" id="Sanction" required="" value="Sanction"> <label for="Sanction">Irrecevabilité</label>
                                        </div>
                                    </div>
                                    <span class="invalid-feedback"></span>
                                </div>
